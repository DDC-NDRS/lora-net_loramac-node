...
typedef struct {
    ...
    struct {
        ...
        struct PacketParamsGfsk_s {
            ...
            RadioPacketLengthModes_t HeaderType;                //!< If the header is explicit, it will be transmitted in the GFSK packet.
         ...
         */
        struct PacketParamsLoRa_s {
            uint16_t PreambleLength; //!< The preamble length is the number of LoRa symbols in the preamble
            RadioLoRaPacketLengthsMode_t HeaderType;            //!< If the header is explicit, it will be transmitted in the LoRa packet.
                                                                //!< If the header is implicit, it will not be transmitted
